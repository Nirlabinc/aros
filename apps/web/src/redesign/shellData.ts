...
export interface ChatMsg { from: 'shre' | 'me'; text: string; meta?: string; agent?: string; tools?: string[]; attachments?: import('./attach/attachments').Attachment[]; catalog?: import('./attach/attachments').CatalogState; upc?: string; }
